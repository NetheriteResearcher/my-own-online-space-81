      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="relative">
            <div className="w-full h-96 bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-gray-800 flex items-center justify-center relative overflow-hidden group">
              ...
              <div className="text-8xl font-bold text-red-500/30 relative z-10 transition-transform duration-500 group-hover:scale-110">
                🧠
              </div>
              <div className="absolute inset-0 bg-[linear-gradient(rgba(239,68,68,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(239,68,68,0.1)_1px,transparent_1px)] bg-[size:20px_20px] opacity-50"></div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              {['PyTorch', 'TensorFlow', 'Hugging Face', 'MLflow', 'Kubernetes'].map((tech) => (
                <span key={tech} className="px-4 py-2 bg-gray-900 border border-gray-700 rounded-full text-red-400 text-sm font-mono hover:border-red-500 transition-colors">
                  {tech}
                </span>
              ))}
            </div>
            <button className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-lg hover:from-red-700 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 border border-red-500/50 mt-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div key={index} className="text-center p-6 rounded-xl bg-gray-900/50 border border-gray-800 hover:border-red-500/50 hover:bg-gray-900 transition-all duration-300 transform hover:-translate-y-2 group">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-full mb-4 group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
